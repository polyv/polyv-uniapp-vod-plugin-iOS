...
@protocol PLVIJKMediaPlayback;

#pragma mark PLVIJKMediaPlayback

@protocol PLVIJKMediaPlayback <NSObject>
...
/// add by polyv
IJK_EXTERN NSString *const IJKMPMoviePlayerSeiDidChangeNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerSeiDidChangeTypeUserInfoKey;
IJK_EXTERN NSString *const IJKMPMoviePlayerSeiDidChangeDataUserInfoKey;
...
@interface PLVIJKMediaUrlOpenData: NSObject
